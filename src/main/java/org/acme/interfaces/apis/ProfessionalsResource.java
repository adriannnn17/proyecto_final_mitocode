...
public interface ProfessionalsResource {
    ...
    @GET
    @Produces("application/json")
    CompletionStage<ProfesionalSchemaResponse> findProfessional(@PathParam("idProfessional") String idProfessional);
    ...
    @PUT
    @Consumes("application/json")
    CompletionStage<Void> updateProfessional(@PathParam("idProfessional") String idProfessional,
    ...
    @Path("/{idProfessional}")
    @DELETE
    CompletionStage<Void> deleteProfessional(@PathParam("idProfessional") String idProfessional);
}
